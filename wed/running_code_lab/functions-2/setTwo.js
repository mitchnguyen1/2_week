...
//function answer() is defined as a parameter
multiply(4, 3, answer => {
...
// CODE HERE
//make a set from the array, then make an array from the set
const uniq = (arr,cb) => cb(Array.from(new Set(arr)))
...
// CODE HERE
uniq(names,cb =(uniqArr)=> {console.log('The new names array with dupes removed is',uniqArr)})
...
// CODE HERE 
//using for each and holding each element and index 
...
// CODE HERE
const addingFactory = num1 => function(num2){return num1+num2}
