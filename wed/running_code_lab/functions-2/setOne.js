...
return that when the function is invoked, it will print: 'The first parameter is [parameter1]. The second parameter is [parameter2]'.
*/

// CODE HERE
const oneLine = (num1,num2) => `The first parameter is ${num1}. The second parameter is ${num2}`
...
and lastName of your choice, and a callback function that takes a parameter of fullName. The callback function will print 'Hello, my full name is [fullName]'. 
*/
...
const callBack = (fullName) => console.log(`Hello, my full name is ${fullName}`)

// INVOKE 'GREETING FUNCTION' HERE
greeting("Mitchell","Nguyen",callBack)
...
// CODE HERE
pricesPlusTax(prices,callBackTotal)
